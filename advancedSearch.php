...
<head>
    ...
    <title>Advanced Search | LushLanka</title>
                    ...
                    <div class="offset-lg-4 col-12 col-lg-4">
                        <div class="row">    
                            ...
                            <div class="col-10 text-center">
                                <P class="fs-1 text-info-50 fw-bold mt-3 pt-2">Advanced Search</P>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="offset-lg-1 col-12 col-lg-10">
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-2 mt-2 mb-1 d-grid">
                                <button class="btn btn-outline-info" onclick="advancedSearch(0);">Search</button>
                            </div>
                            <div class="col-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-lg-4 mb-3">
                                        <select class="form-select" id="m">
                                            ...
                                            $model_rs = Database::search("SELECT * FROM size");
                                            $model_num = $model_rs->num_rows;

                                            for ($x = 0; $x < $model_num; $x++) {
                                                $model_data = $model_rs->fetch_assoc();
                                            ?>
                                                <option value="<?php echo $model_data["size_id"]; ?>"><?php echo $model_data["size_name"]; ?></option>
                                            <?php
                                            }
                    ...
                    <div class="offset-lg-1 col-12 col-lg-10 text-center">
                        <div class="row" id="view_area">
                            <div class="offset-5 col-2 mt-5">
                                <span class="fw-bold text-info-50"><i class="bi bi-search h1" style="font-size: 100px;"></i></span>
                            </div>
                            <div class="offset-3 col-6 mt-3 mb-5">
                                <span class="h1 text-info-50 fw-bold">No Items Searched Yet...</span>
                            </div>
                        </div>
                    </div>
                </div>
