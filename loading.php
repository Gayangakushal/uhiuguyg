...
<body>
    ...
    <div class="loading-page">
        <svg id="svg" xmlns="http://www.w3.org/2000/svg" height="16" width="14" viewBox="0 0 448 512">
...
<script>
    // Simulating a delay before redirecting to the index page
    setTimeout(function() {
        window.location.href = "index.php"; // Redirect to home page after delay
    }, 3000); // Simulating a 3-second delay; replace this with your actual operation time
</script>
